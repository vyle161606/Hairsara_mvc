...
namespace DoAnCoSo.Areas.Admin.Controllers
{
    public class SeatsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SeatId,SeatNumber,Availability")] Seat seat)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SeatId,SeatNumber,Availability")] Seat seat)
        {
            if (ModelState.IsValid)
            {
